...
<script defer src="<c:url value="js/jquery.maskedinput.js"/>" type="text/javascript"></script>
<script defer src="<c:url value="js/mascaras.js"/>" type="text/javascript"></script>
